...
LOOP_TILEMAP_FRAME_1_FASE_1:
	bgt t0, t1, FIM_FRAME_1_FASE_1		# Enquanto t0 < ultima matriz do tilemap, faca o abaixo
		lui t4, 0xFF100	# Carrega os 20 bits mais a esquerda de t4 com ENDERECO_INICIAL_FRAME : Nesse caso do Frame 0
		...
		bne t5, t2, ITERA_LOOP_TILEMAP_FRAME_1_FASE_1	# Compare com o valor no byte atual do Tilemap.
		la t5, IMAGEM_1		# Se o byte atual == 1, pegue a imagem_1
		j PREENCHE_MATRIZ_FRAME_1_FASE_1	# Printa a matriz do byte atual

# # Os casos abaixos pegam a imagem que deve ser printada
# CASO_0_FRAME_1_FASE_1:
# 		li t2, 0		# Pegue o valor 0
# 		bne t5, t2, CASO_1_FRAME_1_FASE_1	# Compare com o valor no byte atual do Tilemap
# 		la t5, IMAGEM_0		# Se o byte atual == 0, pegue a imagem_0
# 		j PREENCHE_MATRIZ_FRAME_1_FASE_1	# Printa a matriz do byte atual
# CASO_1_FRAME_1_FASE_1:
# 		li t2, 1		# Pegue o valor 0										
# 		bne t5, t2, CASO_2_FRAME_1_FASE_1	# Compare com o valor no byte atual do Tilemap
# 		la t5, IMAGEM_1		# Se o byte atual == 1, pegue a imagem_1
# 		j PREENCHE_MATRIZ_FRAME_1_FASE_1	# Printa a matriz do byte atual
# CASO_2_FRAME_1_FASE_1:
# 		li t2, 2		# Pegue o valor 0
# 		bne t5, t2, CASO_3_FRAME_1_FASE_1	# Compare com o valor no byte atual do Tilemap
# 		la t5, IMAGEM_2		# Se o byte atual == 2, pegue a imagem_2
# 		j PREENCHE_MATRIZ_FRAME_1_FASE_1	# Printa a matriz do byte atual							
# CASO_3_FRAME_1_FASE_1:
...
PREENCHE_MATRIZ_FRAME_1_FASE_1:
		# Inicializa linha e ultima linha
		li s0, 0	# Linha inicial = 0
		li s1, 16	# Linha final = 16
# Loop para printar cada linha da matriz
LOOP_LINHAS_MATRIZ_FRAME_1_FASE_1:
	beq s0, s1, ITERA_LOOP_TILEMAP_FRAME_1_FASE_1	# Enquanto i < 16, faca o abaixo
	...
	LOOP_COLUNA_FRAME_1_FASE_1:			
		beq t2,t3,SOMA_LINHA_FRAME_1_FASE_1	# Enquanto coluna < 16
		#PREENCHE_BYTE
		...
		addi t2,t2,1		# coluna++
		j LOOP_COLUNA_FRAME_1_FASE_1		# Retorne para a verificacao do Loop das Colunas

# Etapa de iteracao da linha e de correcao do pixel inicial				
SOMA_LINHA_FRAME_1_FASE_1:
	addi s0, s0, 1	# linha ++
	...
	j LOOP_LINHAS_MATRIZ_FRAME_1_FASE_1	# Retorne para a verificacao do Loop das Linhas Matriz

# Etapa de iteracao do byte no Tilemap		
ITERA_LOOP_TILEMAP_FRAME_1_FASE_1:
		addi t0, t0, 1	# t0++
		j LOOP_TILEMAP_FRAME_1_FASE_1 # Retorne para a verificacao do Loop que percorre o Tilemap
# Fim_FRAME_1_FASE_1 do programa
FIM_FRAME_1_FASE_1:
